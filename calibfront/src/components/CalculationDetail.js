    ...
    <div className="container-fluid mt-5 pt-3">
      <div className="row mb-5 d-flex" style={{ display1: 'flex', height1: '100vh' }}>
        ...
        <div className="col col-1 sticky-top align-self-start d-flex flex-column gap-2">                
          ...
          <Link to={`/calculations/${calculation.id}/edit`} className="btn btn-primary text-break w-100 py-2">
            <i class="bi bi-file-text me-2"></i>
            Редактировать
          </Link>
          <Link to={`/calculations/${id}/solutions/${calculation.CountDensities}`} className="btn btn-info text-break w-100 py-2">
