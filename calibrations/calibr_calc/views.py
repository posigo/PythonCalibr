...
from . serialisers import CalculationsSerializer, SolutionsSerializer, OpticalDensitiesSerializer
...
class CalculationsViewSet(viewsets.ModelViewSet):
    ...
    def get_permissions(self):
        if self.action in ['list', 'retrieve', 'uncertainty', 'export_to_excel']:
